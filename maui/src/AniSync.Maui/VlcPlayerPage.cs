...
/// <summary>
/// Full-screen native player page hosting a LibVLCSharp <see cref="VideoView"/>
/// bound to the MediaPlayer that <see cref="VlcMediaPlayer"/> built.
...
public sealed class VlcPlayerPage : ContentPage
{
    ...
    public VlcPlayerPage(MediaPlayer player, string title)
    {
        ...
        var video = new VideoView { MediaPlayer = player, VerticalOptions = LayoutOptions.Fill, HorizontalOptions = LayoutOptions.Fill };
